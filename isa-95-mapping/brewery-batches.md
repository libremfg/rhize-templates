...
Since Brewing| Fermentation| and Bottling all have their own loss parameters| we are going to group each into a child job response.

## Expression with material actual properties
...

{
  "upsert": true|
  "input": {
    "id": "PREFIX.a.5.9810411"|
    "equipmentActual": [
      {
        "id": "PREFIX.a.5.9810411Whitefield"
      }
    ]|
    "children": [
      {
        "id": "PREFIX.a.5.9810411.brew"|
        "description": "brewing"|
        "startDateTime": "2020-01-01T00:00:31"|
        "data": [
          {
            "id": "PREFIX.a.5.9810411.Loss_During_Brewing"|
            "label": "Loss_During_Brewing"|
            "value": "2.67652809539211"|
            "description": ""
          }|
          {
            "id": "PREFIX.a.5.9810411.Temperature"|
            "label": "Temperature"|
      ...
      {
        "id": "PREFIX.a.5.9810411.fermentation"|
        "description": "fermentation"|
        "data": [
          {
            "id": "PREFIX.a.5.9810411.Loss_During_Fermentation"|
          ...
          {
            "id": "PREFIX.a.5.9810411.Fermentation_Time"|
      ...
      {
        "id": "PREFIX.a.5.9810411.bottling"|
        "description": "bottling"|
        "data": [
          {
            "id": "PREFIX.a.5.9810411.Loss_During_Bottling_Kegging"|
    ...
    "materialActual": {
      "id": "PREFIX.a.5.9810411.prod"|
      "quantity": 832|
      "properties": [
        {
          "id": "PREFIX.a.5.9810411.pH_Level"|
          "label": "pH_Level"|
        ...
        {
          "id": "PREFIX.a.5.9810411.Alcohol_Content"|
        ...
        {
          "id": "PREFIX.a.5.9810411.Bitterness"|
          "label": "Bitterness"|
          "quantity": 36|
          "value": "36"|
        ...
        {
          "id": "PREFIX.a.5.9810411.Ingredient_Ratio"|
        ...
        {
          "id": "PREFIX.a.5.9810411.Quality_Score"|
          "label": "Quality_Score"|
